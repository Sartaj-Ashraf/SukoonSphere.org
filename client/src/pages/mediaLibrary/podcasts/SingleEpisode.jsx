    ...
    <div className="min-h-screen py-4">
      <div className="w-full max-w-7xl mx-auto sm:px-4">
        ...
        <div className="mb-6 bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-md border border-gray-100">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-[var(--grey--900)] mb-3 leading-tight">
            {episode.title}
          </h2>
          ...
          {/* Description */}
          <div className="bg-gray-50 rounded-lg p-2 border border-gray-100 mb-8">
            {/* Progress Bar */}
            ...
            <div className="flex items-center justify-center space-x-4 sm:space-x-6 md:space-x-8">
              ...
              <button
                ...
                className="p-2 sm:p-5 md:p-3 bg-[var(--primary)] rounded-full text-white hover:bg-[var(--secondary)] transition-all duration-200 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl"
            ...
            <div className="mt-4">
              ...
              <p className="text[var(---grey-800)] leading-relaxed text-sm">
                {episode.description}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[250px,1fr] lg:grid-cols-[300px,1fr] gap-4 md:gap-6 lg:gap-8">
            ...
            <div className="flex flex-col justify-between space-y-4 md:space-y-0">
              ...
              <div className="text-center md:text-left">
                <h1 className="text-xl  md:text-2xl font-bold text-gray-800 mb-2 line-clamp-2">
                  {episode.title}
                </h1>
                <p className="text-base sm:text-lg text-blue-600 mb-2 sm:mb-4">
                  {episode.author}
                </p>
