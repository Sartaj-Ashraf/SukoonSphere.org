...
const CreateNewPodcast = ({ setShowModal }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!title || !description || !episodeNo) {
        ...
        try {
            ...
            // Append all fields, ensuring they exist
            formData.append('title', title.trim());
            formData.append('description', description.trim());
            formData.append('episodeNo', episodeNo.toString());
            
            // Append files with field names matching the backend expectations
            if (audioFile) {
