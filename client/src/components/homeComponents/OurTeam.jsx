        ...
        <>
            ...
            <div className="px-[1.5rem] max-w-7xl mx-auto flex flex-col items-center justify-center text-center pt-20" data-aos="fade-up" >
                <div className="flex flex-row justify-center mb-12 bg-contain md:bg-center object-bottom gap-12"
                    ...
                    <div className="w-56 h-56 rounded-lg overflow-hidden m-[-100px]" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <div className="w-56 h-56 rounded-lg overflow-hidden" data-aos="fade-up-right">
                ...
                <Link to="/about/our-team" className='text-blue-700'>
                    <h2 className="text-[var(--grey--900)]  font-bold mb-4  text-[1.6rem] md:text-[2.5rem] lg:text-[3.5rem] leading-[1.2]" data-aos="fade" data-aos-duration="2000">
