...
const UserAnswers = () => {
    ...
    const {
        ...
        queryFn: async ({ pageParam = 1 }) => {
            const response = await customFetch.get(`/qa-section/user-answers/${user?._id}?page=${pageParam}&limit=10`);
        ...
        <div className="lg:p-6 bg-white rounded-xl shadow-sm">
            ...
            <div className="flex items-center justify-between mb-4 lg:mb-8">
                <h2 className="text-2xl font-bold text-gray-800">
                    Answers <span className="text-blue-500 ml-2">{allAnswers.length}</span>
                </h2>
            </div>
            ...
            {allAnswers.length === 0 ? (
                <div className="text-center py-12 px-4">
                    ...
                    <h2 className="text-xl font-semibold text-gray-700 mb-2">No answers yet</h2>
